...
# The physical carrier for a worker-originated off-lane tool operation. It is minted by
# the server, never user-submitted; the permit and correlation ride the worker message,
# so the spec itself is empty.
