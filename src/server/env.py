...
WORKER_SERVE_INGRESS_PORT: int = parse_int_env("WORKER_SERVE_INGRESS_PORT", 8100)
WORKER_SERVE_INGRESS_PUBLIC_URL: str = os.getenv("WORKER_SERVE_INGRESS_PUBLIC_URL", "")
