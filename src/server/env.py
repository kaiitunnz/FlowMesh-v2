...
WORKER_SERVE_INGRESS_ENABLED: bool = parse_bool_env(
    "WORKER_SERVE_INGRESS_ENABLED", False
)
WORKER_SERVE_INGRESS_BIND_HOST: str = os.getenv(
    "WORKER_SERVE_INGRESS_BIND_HOST", "0.0.0.0"
)
WORKER_SERVE_INGRESS_AUTHORITY: str = os.getenv("WORKER_SERVE_INGRESS_AUTHORITY", "")
WORKER_SERVE_INGRESS_PORT_LOW: int = parse_int_env(
    "WORKER_SERVE_INGRESS_PORT_LOW", 34000
)
WORKER_SERVE_INGRESS_PORT_HIGH: int = parse_int_env(
    "WORKER_SERVE_INGRESS_PORT_HIGH", 34099
)
WORKER_SERVE_INGRESS_TLS_CERT: str = os.getenv("WORKER_SERVE_INGRESS_TLS_CERT", "")
WORKER_SERVE_INGRESS_TLS_KEY: str = os.getenv("WORKER_SERVE_INGRESS_TLS_KEY", "")
