...
| `sandbox` | `SandboxSessionExecutor` | One private sandbox session, running its declared commands one per episode step against its own filesystem, with network egress denied |
